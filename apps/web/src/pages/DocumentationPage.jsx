...
const DocumentationPage = () => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">System Documentation</h1>
        <p className="text-gray-400">Auto-generated architecture and feature reference.</p>
      </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <GlassCard className="p-6">
            <h2 className="text-lg font-bold text-white flex items-center gap-2 mb-4">
              <Code className="w-5 h-5 text-[#00d4ff]" /> Architecture
            </h2>
          ...
          <GlassCard className="p-6">
            <h2 className="text-lg font-bold text-white flex items-center gap-2 mb-4">
              <Database className="w-5 h-5 text-[#00d4ff]" /> Database
            </h2>
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex justify-between">
                <span className="text-gray-500">Auth Providers</span>
        ...
        <div className="lg:col-span-2">
          <GlassCard className="p-6 h-full">
            <h2 className="text-xl font-bold text-white flex items-center gap-2 mb-6">
              <Layout className="w-5 h-5 text-[#00d4ff]" /> Core Features
            </h2>
